export default function MarketingSuccessStories() {
  return (
    <section id="stories" className="border-t border-gray-100 bg-gray-50/30 py-20 sm:py-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-6 text-sm text-gray-400">
            ...
            <a href="/contact" className="font-bold text-blue-600 hover:text-blue-700">contact page</a>.
            It will be the first one we publish.
          </p>
        </div>
      </div>
    </section>
