...
export default function LandingFeatures() {
  return (
    <section id="features" className="border-y border-gray-100 bg-[#f7f9fc] py-24 sm:py-32">
      <div className="mx-auto max-w-6xl px-5 sm:px-8">
        <div className="max-w-2xl">
          <p className="text-[10px] font-semibold uppercase tracking-[0.22em] text-navy-700">Features</p>
        ...
        <div className="mt-16 grid gap-4 sm:gap-5 lg:grid-cols-12">
          <div className="rounded-2xl border border-gray-200/70 bg-white p-8 sm:p-12 lg:col-span-7">
            <p className="font-serif text-[11.5px] italic text-navy-700">01</p>
            <h3 className="mt-4 text-2xl font-medium tracking-tight text-gray-900 sm:text-[26px]">Mock Exams</h3>
            ...
            <div className="mt-10 rounded-xl border border-gray-200/70 bg-white p-5 shadow-[0_1px_2px_rgba(22,44,69,0.03),0_12px_28px_-24px_rgba(22,44,69,0.16)] sm:p-7">
              ...
              <div className="mt-4 space-y-2">
                ...
                <div className="flex items-center gap-2.5 rounded-lg border border-navy-200 bg-navy-50/70 px-3 py-2">
                  <span className="flex h-5 w-5 items-center justify-center rounded bg-navy-800 text-[10px] font-medium text-white">
                    B
                  </span>
                  <span className="text-[12.5px] text-navy-900">brief</span>
                  <span className="ml-auto text-[9px] font-medium uppercase tracking-[0.14em] text-navy-700">
                    Selected
                  </span>
                </div>
              </div>
          ...
          <div className="rounded-2xl border border-gray-200/70 bg-white p-8 lg:col-span-5">
            <p className="font-serif text-[11.5px] italic text-navy-700">02</p>
            <h3 className="mt-4 text-xl font-medium tracking-tight text-gray-900">Revision Notes</h3>
            ...
            <div className="mt-10 rounded-xl border border-gray-200/70 bg-gray-50/50 p-5 sm:p-6">
          ...
          <div className="rounded-2xl border border-gray-200/70 bg-white p-8 lg:col-span-4">
            <p className="font-serif text-[11.5px] italic text-navy-700">03</p>
            <h3 className="mt-4 text-xl font-medium tracking-tight text-gray-900">Performance Tracking</h3>
            <p className="mt-4 text-[14px] leading-[1.85] text-gray-600">
            ...
            <div className="mt-10 space-y-5">
              {TRACKED_SUBJECTS.map((row) => (
                <div key={row.label}>
                  ...
                  <div className="mt-2 h-[3px] w-full overflow-hidden rounded-full bg-navy-50">
                    <div className="h-full rounded-full bg-navy-700" style={{ width: `${row.pct}%` }} />
                  </div>
                </div>
              ))}
            </div>
          ...
          <div className="flex flex-col justify-between rounded-2xl border border-gray-200/70 bg-white p-8 sm:p-10 lg:col-span-8">
            <div>
              <p className="font-serif text-[11.5px] italic text-navy-700">04</p>
              <h3 className="mt-4 text-xl font-medium tracking-tight text-gray-900">Verified Questions</h3>
              <p className="mt-4 max-w-md text-[14px] leading-[1.85] text-gray-600">
            ...
            <ul className="mt-10 space-y-3.5">
              {VERIFICATION_STEPS.map((step) => (
                <li key={step} className="flex items-center gap-3">
                  <span className="flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-navy-50">
                    <Check className="h-3 w-3 text-navy-700" strokeWidth={2.5} />
                  </span>
