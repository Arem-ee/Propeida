      ...
      <main className="mx-auto max-w-3xl px-4 py-20 sm:py-24">
        ...
        <div className="mt-10 space-y-8 text-sm text-gray-500 leading-relaxed">
          <section>
            ...
            <p>
              You must provide a valid email address to create a PrepIQ account. You are responsible for maintaining the confidentiality of your password and for all activity that occurs under your account. PrepIQ is not liable for any loss or damage arising from unauthorized use of your account.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              PrepIQ offers a free tier with limited access to practice questions and mock exams. The free tier limits are clearly stated on the pricing page and within the application. The Pro upgrade is a one-time payment of ₦1,500 (fifteen hundred Nigerian Naira) processed through Paystack. Pro access is tied to your account and is non-transferable.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              PrepIQ provides practice and preparation material. It does not guarantee any specific score, grade, percentile, ranking, or admission outcome on JAMB, WAEC, Post-UTME, or any other examination. Performance on the platform does not predict performance on actual exams. Results depend on the individual student, their preparation, and factors outside PrepIQ&apos;s control.
            </p>
            <p className="mt-3">
              THE PRACTICE MATERIAL IS PROVIDED &ldquo;AS IS&rdquo; WITHOUT WARRANTY OF ANY KIND, EXPRESS OR IMPLIED, INCLUDING BUT NOT LIMITED TO THE IMPLIED WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, OR NON-INFRINGEMENT. IN NO EVENT SHALL PREPIQ BE LIABLE FOR ANY CLAIM, DAMAGES, OR OTHER LIABILITY ARISING FROM THE USE OF THE PLATFORM, INCLUDING BUT NOT LIMITED TO EXAM OUTCOMES OR ADMISSION RESULTS.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              The PrepIQ question bank is compiled from the recollections of past candidates who previously sat the University of Ilorin Post-UTME screening exercise. These questions are not sourced from, provided by, or endorsed by the University of Ilorin, the Joint Admissions and Matriculation Board (JAMB), the West African Examinations Council (WAEC), or any other official examination body.
            </p>
            <p className="mt-3">
              PrepIQ has no affiliation, partnership, or official relationship with the University of Ilorin, JAMB, WAEC, or any of their respective departments or personnel. The questions are practice material only and do not represent actual examination content that may appear on any official test.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              You agree not to use PrepIQ for any unlawful purpose or in any way that could damage, disable, or impair the platform. This includes attempting to scrape the question bank, create multiple accounts to bypass free tier limits, or engage in any activity that could constitute exam fraud.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              PrepIQ reserves the right to update these terms at any time. Registered users will be notified of material changes via the email address on their account. Continued use of the platform after a change constitutes acceptance of the updated terms.
            </p>
          </section>
