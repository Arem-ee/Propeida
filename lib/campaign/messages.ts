...
// The live site is https://propeida.online — flip CAMPAIGN_CTA_URL once
// propeida.com resolves to the app.

export const CAMPAIGN_CTA_URL = 'https://propeida.com'
...
export const CAMPAIGN_WHATSAPP_CHANNEL_MESSAGE =
  ...
  '⏰ Ends in 24 hours. 👉 https://propeida.com'
...
const CAMPAIGN_PARENT_PITCH = [
  ...
  '',
  'Here’s the app: https://propeida.com',
].join('\n')
