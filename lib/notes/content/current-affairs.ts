    ...
    sections: [
      {
        ...
        bullets: [
          ...
          'The doctrine of separation of powers keeps the three arms independent; checks and balances let each limit the others.',
        ],
      },
      {
      ...
      },
      {
        ...
        bullets: [
          ...
          'As of 2026, Bola Ahmed Tinubu is President (sworn in 29 May 2023) with Vice President Kashim Shettima.',
        ],
      },
      {
    ...
    sections: [
      {
        ...
        bullets: [
          ...
          'NAFDAC — National Agency for Food and Drug Administration and Control: regulates food, drugs, and similar products.',
      ...
      },
      {
        ...
        bullets: [
          ...
          'NIA — National Intelligence Agency and DSS — Department of State Services handle foreign and domestic intelligence respectively.',
        ],
      },
      {
        heading: 'Exam tactics for institutions',
        bullets: [
          'Read the acronym twice: EFCC and EFCC-adjacent letters (EFFC) are favourite distractors.',
          'Match by the lead word: "Commission" usually means regulation; "Agency" usually means enforcement or service.',
          'When two options both exist (e.g., NNPC vs NPDC), pick the one named in the question’s context.',
        ],
      },
    ],
    examTip:
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          'AU — African Union: 55 member states, headquartered in Addis Ababa; successor to the OAU (founded 1963, transformed in 2002).',
          ...
          'The Commonwealth: association of mainly former British colonies, including Nigeria, linking countries through shared values and the English language.',
        ],
      },
      {
    ...
    sections: [
      {
        ...
        bullets: [
          ...
          'Exchange-rate reform: the naira was allowed to float more freely, causing it to weaken sharply against the dollar.',
          ...
          'Inflation has stayed elevated, with the CBN responding by raising the monetary policy rate repeatedly.',
        ],
      },
      {
        ...
        bullets: [
          ...
          'The next general election (presidential and National Assembly) is constitutionally due in 2027; by 2026 parties were already holding primaries and coalitions.',
      ...
      },
      {
        ...
        bullets: [
          ...
          'Prefer asking "what has changed recently in X?" over memorising an old year’s facts.',
          'State institutions, not individuals, carry most of the marks — be careful with names of office holders that change.',
        ],
      },
    ],
    examTip:
